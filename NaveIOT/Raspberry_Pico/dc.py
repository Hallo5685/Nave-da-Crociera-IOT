    ...
    while True:
        ...
        try:
            ...
            jsonDaInviare = {
                ...
                "sensore": {
                "nome": "DHT11", 
                "tmin": configurazioneDispositivo['sensore']['tmin'], 
                "tmax": configurazioneDispositivo['sensore']['tmax'], 
                "umin": configurazioneDispositivo['sensore']['umin'], 
                "umax": configurazioneDispositivo['sensore']['umax'], 
                "erroret": configurazioneDispositivo['sensore']['erroret'], 
                "erroreu": configurazioneDispositivo['sensore']['erroreu']
                },
                    "identita": "DC001-01",
                    "osservazione": {
